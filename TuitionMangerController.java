...
public class TuitionManagerController {
    ...
    /**
     * Helper method that is called when text fields need to be set back to their default texts.
     * We use blank spaces or null values as the default texts so that should another command be
     * run on, the text fields are empty and ready to update with success or error messages
